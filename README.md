...
[![CI](https://github.com/awiggy/daily_stock_analysis/actions/workflows/ci.yml/badge.svg)](https://github.com/awiggy/daily_stock_analysis/actions/workflows/ci.yml)
...
| Secret 名称 | 说明 | 必填 |
|------------|------|:----:|
| `ANSPIRE_API_KEYS` | [Anspire](https://open.anspire.cn/) API Key，一Key同时启用全球热门大模型和联网搜索，无需科学上网，含免费额度 | **推荐** |
| `AIHUBMIX_KEY` | [AIHubMix](https://aihubmix.com/) API Key，一Key切换使用全系模型，无需科学上网，本项目可享 10% 优惠 | **推荐** |
...
```bash
# 克隆项目
git clone https://github.com/awiggy/daily_stock_analysis.git && cd daily_stock_analysis
...
有问题请在 [GitHub Issues](https://github.com/awiggy/daily_stock_analysis/issues) 提交。

## 📄 License

[MIT License](LICENSE) © 2026 ZhuLinsen

本项目基于 [ZhuLinsen/daily_stock_analysis](https://github.com/ZhuLinsen/daily_stock_analysis) 修改。
