...
|-------------|-------------|:--------:|
| `ANSPIRE_API_KEYS` | [Anspire](https://open.anspire.cn/) API key, one key for popular LLMs and web search with free quota for this project | **Recommended** |
...
Please submit issues at [GitHub Issues](https://github.com/awiggy/daily_stock_analysis/issues).

## 📄 License

[MIT License](../LICENSE) © 2026 ZhuLinsen

This project is based on [ZhuLinsen/daily_stock_analysis](https://github.com/ZhuLinsen/daily_stock_analysis).
