...
| Secret 名稱 | 說明 | 必填 |
|-------------|------|:----:|
| `ANSPIRE_API_KEYS` | [Anspire](https://open.anspire.cn/) API Key，一 Key 同時啟用全球熱門大模型和聯網搜尋，含本項目免費額度 | **推薦** |
| `AIHUBMIX_KEY` | [AIHubMix](https://aihubmix.com/) API Key，一 Key 切換使用全系模型，本項目可享 10% 優惠 | **推薦** |
...
| `SERPAPI_API_KEYS` | [SerpAPI](https://serpapi.com/baidu-search-api)：搜尋引擎結果補強，適合即時金融新聞 | **推薦** |
...
請在 [GitHub Issues](https://github.com/awiggy/daily_stock_analysis/issues) 提交。

## 📄 License

[MIT License](../LICENSE) © 2026 ZhuLinsen

本項目基於 [ZhuLinsen/daily_stock_analysis](https://github.com/ZhuLinsen/daily_stock_analysis) 修改。
